...
ifneq "$(KERNELVERSION)" "6.1.0"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "ccache aarch64-linux-gnu-gcc"
include/config/auto.conf: FORCE
endif
...
ifneq "$(CC_VERSION_TEXT)" "aarch64-linux-gnu-gcc (Ubuntu 9.4.0-1ubuntu1~20.04.2) 9.4.0"
include/config/auto.conf: FORCE
endif
...
ifneq "$(AR)" "ccache aarch64-linux-gnu-ar"
include/config/auto.conf: FORCE
endif
